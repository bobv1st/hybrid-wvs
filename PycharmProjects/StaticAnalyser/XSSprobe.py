...
for Cross-Site Scripting (XSS) vulnerabilities using reflected and stored detection.
Results are written to xss_probe_results.ndjson.
"""
...
# Field types that are never useful to fuzz for XSS
...
def _probe_field(
    ...
    for label, payload, detection_re in REFLECTED_PAYLOADS:
        ...
        try:
            ...
            # Reflected XSS: payload echoed back unescaped in the same response
